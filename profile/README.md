...
Organisasi GitHub tim developer  
**Program Studi Teknik Informatika – Universitas Muhammadiyah Cirebon**.  
Fokus pada pengembangan **Website Profile Prodi Teknik Informatika UMC** dan sistem pendukungnya.
...
|-----------|-----------|
| [it-umc-fe](https://github.com/umc-dev/it-umc-fe) | Frontend website profile Prodi TI UMC |
| [it-umc-dashboard](https://github.com/umc-dev/it-umc-dashboard) | Dashboard admin manajemen konten |
| [it-umc-be](https://github.com/umc-dev/it-umc-be) | Backend API  |
